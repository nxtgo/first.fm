...
func Debugf(f string, a ...any) { Log.Debugf(f, a...) }
func Infof(f string, a ...any)  { Log.Infof(f, a...) }
func Warnf(f string, a ...any)  { Log.Warnf(f, a...) }
func Errorf(f string, a ...any) { Log.Errorf(f, a...) }
func Fatalf(f string, a ...any) { Log.Fatalf(f, a...) }

func Debugw(msg string, f F, a ...any) { Log.Debugw(msg, f, a...) }
func Infow(msg string, f F, a ...any)  { Log.Infow(msg, f, a...) }
func Warnw(msg string, f F, a ...any)  { Log.Warnw(msg, f, a...) }
func Errorw(msg string, f F, a ...any) { Log.Errorw(msg, f, a...) }
func Fatalw(msg string, f F, a ...any) { Log.Fatalw(msg, f, a...) }
