...
import (
	...
	"go.fm/internal/bot/image/clone"
	"go.fm/internal/bot/image/fcolor"
	"go.fm/internal/bot/image/math/f64"
...
func Blend(bg image.Image, fg image.Image, fn func(fcolor.RGBAF64, fcolor.RGBAF64) fcolor.RGBAF64) *image.RGBA {
	...
	var w, h int
	w = min(bgBounds.Dx(), fgBounds.Dx())
	h = min(bgBounds.Dy(), fgBounds.Dy())
