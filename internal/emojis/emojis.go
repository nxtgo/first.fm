...
func (e Emoji) Snowflake() snowflake.ID {
	return snowflake.MustParse(e.ID)
}
...
var (
	...
	// last.fm
	EmojiLastFMRed   = Emoji{ID: "1418268922448187492", Name: "lastfm", Animated: false}
	EmojiLastFMWhite = Emoji{ID: "1418269025959546943", Name: "lastfm_white", Animated: false}
